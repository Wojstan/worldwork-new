...
export function EmployerJobBox({ job }: Props) {
  ...
  return (
    <Link href='/company/add'>
      <div
        className="border border-black h-28 rounded-xl bg-white z-50 flex items-center justify-between px-6 hover:bg-[#F8F2FF] hover:border-[#CFAAFF] transition cursor-pointer"
      >
